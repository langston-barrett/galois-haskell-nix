...
** Compiler support
   ...
   - GHC 8.2.2: Error while building macaw. To be investigated...
   ...
   - GHC 8.6.1: Unsupported. Too many upstream dependencies aren't ready.
...
** TODO TODO
  ...
  - Update all packages
  - Don't haddock anything
  - Figure out linking with gold
